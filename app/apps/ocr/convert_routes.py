...
Two endpoints share the same conversion (parse_markdown -> render_docx)
and only differ in how the Markdown arrives: as a JSON string in the
request body, or as an uploaded .md file.
"""
