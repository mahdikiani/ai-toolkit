...
from apps.artifacts.routes import router as artifacts_router
from apps.converter.routes import router as artifact_convert_router
from apps.converter.task_routes import router as conversions_router
