...
async def ocr_task(mock_user: dict[str, str]) -> AsyncGenerator[OcrTask]:
...
@pytest_asyncio.fixture
async def transcribe_task(mock_user: dict[str, str]) -> AsyncGenerator[TranscribeTask]:
...
@pytest_asyncio.fixture
async def translate_task(mock_user: dict[str, str]) -> AsyncGenerator[TranslateTask]:
...
@pytest_asyncio.fixture
async def execution_task(mock_user: dict[str, str]) -> AsyncGenerator[PrompticTask]:
